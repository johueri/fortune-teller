...
public class FortuneTellerRefinementCode {
...
//		 Ask the user for the user's number of siblings.
		...
		// Now coding in colors and modes of transportation 
		  ...
		  if (color.toLowerCase().contains("red")) {
			  ...
			  transport = " falling on your face b/c you entered a ROYGBIV color incorrectly.";
		  }
...
//	 }
	...
	if (birthMonth < 5 && birthMonth > 0) {
	 ...
	 System.out.println(firstName.substring(0, 1).toUpperCase() 
				...
				lastName.substring(1).toLowerCase() + " will retire in " + retirement + " with " + savings + " in the bank, a vacation home in "
